    ...
    <>
      <div className="form-wrapper">
        <div className="form">
          ...
          <input placeholder="e.g. Stephen King" onChange={(e) => {
            if(e.target.value === '') {
          ...
          <input placeholder="e.g. stephenking@lorem.com" type='email' onChange={(e) => {
            if(e.target.value === '') {
          ...
          <input placeholder="e.g. +1 234 567 890" onChange={(e) => {
            if(e.target.value === '') {
      ...
      <button
        className="button"
        onClick={() => {
          if(error.name === null && error.email === null && error.phone === null) {
            setPage('2');
          }
        }}
      >
